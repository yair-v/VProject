...
export const api = {
  login: (payload) => request('/api/login', { method: 'POST', body: JSON.stringify(payload), headers: {} }),
  ...
  createProjectField: (projectId, payload) => request(`/api/projects/${projectId}/fields`, { method: 'POST', body: JSON.stringify(payload) }),
  updateProjectField: (projectId, fieldId, payload) => request(`/api/projects/${projectId}/fields/${fieldId}`, { method: 'PUT', body: JSON.stringify(payload) }),
  deleteProjectField: (projectId, fieldId) => request(`/api/projects/${projectId}/fields/${fieldId}`, { method: 'DELETE' }),
  ...
  getRows: ({ projectId, page, pageSize, search, status }) => request(`/api/projects/${projectId}/rows?page=${page}&pageSize=${pageSize}&search=${encodeURIComponent(search || '')}&status=${encodeURIComponent(status || '')}`),
